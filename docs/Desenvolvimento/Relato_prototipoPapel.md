...
|  18/01/2025    |        18/01/2025          |    1.2     | Atualização do Documento     | [Karolina Vieira](https://github.com/Karolina91) |  [Paola Nascimento](https://github.com/paolaalim) |

# Resultado do Relato do Protótipo de Papel  

## Introdução  

O objetivo deste documento é apresentar os resultados obtidos durante a avaliação dos Protótipos de Papel. A avaliação foi realizada com o propósito de identificar possíveis problemas e oportunidades de melhoria no sistema proposto. A condução da análise seguiu o [Planejamento da Avaliação do Protótipo de Papel](./Planejamento_prototipoPapel.md) e a organização dos dados foi estruturada conforme o [Planejamento do Relato dos Resultados da Avaliação do Protótipo de Papel](./Planejamento_resultados_prototipoPapel.md).
...
A avaliação teve como objetivo analisar o [Protótipo de Papel 1 - Agendar uma consulta com o advogado](./ProtiposdePapel.md), visando identificar pontos de melhoria na interação e na interface. O foco foi explorar aspectos relacionados a alternativas de design e identificar possíveis problemas na interação e na interface. 
...
#### Fonte: [Karolina Vieira](https://github.com/Karolina91)
...
A avaliação teve como objetivo analisar o [Protótipo de Papel  - Inscrever-se no programa de estágio](./ProtiposdePapel.md), visando identificar pontos de melhoria na interação e na interface. O foco foi explorar aspectos relacionados a alternativas de design e identificar possíveis problemas na interação e na interface. 
...
#### Fonte: [Paola Nascimento](https://github.com/paolaalim)
